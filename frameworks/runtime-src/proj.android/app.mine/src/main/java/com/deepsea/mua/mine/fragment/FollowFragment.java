...
import com.deepsea.mua.mine.adapter.FollowsAdapter;
import com.deepsea.mua.mine.databinding.FragmentFollowBinding;
...
public class FollowFragment extends BaseFragment<FragmentFollowBinding> {
    ...
    private void initRecyclerView() {
        mAdapter = new FollowsAdapter(mContext);
    ...
    private void initRefreshLayout() {
        mBinding.refreshLayout.setOnRefreshListener(refreshLayout -> {
            mViewModel.refresh("1").observe(this, new BaseObserver<FollowFanBean>() {
                @Override
        ...
        mBinding.refreshLayout.setOnLoadMoreListener(refreshLayout -> {
            mViewModel.loadMore("1").observe(this, new BaseObserver<FollowFanBean>() {
                @Override
                public void onSuccess(FollowFanBean result) {
                    if (result != null) {
                        FollowFanBean.PageinfoBean pageInfo = result.getPageinfo();
