...
public class ExchangeMdDetailListBean {
    ...
    private List<ExchangeMdDetailItem> cash_list;
    ...
    public List<ExchangeMdDetailItem> getCash_list() {
        return cash_list;
    }

    public void setCash_list(List<ExchangeMdDetailItem> cash_list) {
