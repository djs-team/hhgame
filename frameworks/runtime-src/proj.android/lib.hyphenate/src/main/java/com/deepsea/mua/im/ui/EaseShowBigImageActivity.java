...
import com.deepsea.mua.im.model.EaseImageCache;
import com.deepsea.mua.im.utils.EaseLoadLocalBigImgTask;
import com.deepsea.mua.im.widget.photoview.EasePhotoView;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rl_close).setOnClickListener(new OnClickListener() {
            @Override
