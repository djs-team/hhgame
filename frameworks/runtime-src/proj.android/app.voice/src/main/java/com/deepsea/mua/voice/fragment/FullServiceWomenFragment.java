 ...
 */
public class FullServiceWomenFragment extends BaseFragment<FragmentFullServiceManBinding> {
    ...
    public static FullServiceWomenFragment newInstance(FullServiceUserDialog.OnMicroListener listener, int hongId, String roomId) {
        mListener = listener;
        FullServiceWomenFragment instance = new FullServiceWomenFragment();
    ...
    private void initRefreshLayout() {
        mBinding.refreshLayout.setOnRefreshListener(refreshLayout -> {
            mViewModel.refresh("2").observe(this, new BaseObserver<OnlinesBean>() {
                @Override
        ...
        mBinding.refreshLayout.setOnLoadMoreListener(refreshLayout -> {
            mViewModel.loadMore("2").observe(this, new BaseObserver<OnlinesBean>() {
                @Override
                public void onSuccess(OnlinesBean result) {
