...
//
//                PushEvent pushEvent = JsonConverter.fromJson(extraData, PushEvent.class);
//                AAlertDialog dialog = new AAlertDialog(AppManager.getAppManager().currentActivity());
...
//                    }
//                });
//                dialog.setRightButton("去看看", new AAlertDialog.OnClickListener() {
//                    @Override
//                    public void onClick(View v, Dialog dialog) {
//                        dialog.dismiss();
//                        PageJumpUtils.jumpPushDeeplink(pushEvent);
//                    }
//                });
//                dialog.show();
