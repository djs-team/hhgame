package com.deepsea.mua.core.view.floatwindow.impl;
...
import com.deepsea.mua.core.view.floatwindow.interfaces.BaseFloatView;
import com.deepsea.mua.core.view.floatwindow.interfaces.BaseFloatWindow;
import com.deepsea.mua.core.view.floatwindow.interfaces.LifecycleListener;
import com.deepsea.mua.core.view.floatwindow.utils.L;
import com.deepsea.mua.core.view.floatwindow.utils.ViewUtils;
        ...
        if (mBuilder.mMoveType != MoveType.INACTIVE) {
            getView().setOnTouchListener(new View.OnTouchListener() {
                ...
                private boolean isNeedMoveY(int startY, float upY) {
                    return startY < 0 || upY > screenHeight;
                }
