 ...
 */
public class FriendMineFragment extends BaseFragment<FragmentFriendMessageBinding> {
    @Inject
...
//            mBinding.refreshLayout.autoRefresh();
    ...
    private void setFriendData(List<FriendInfoBean> friendData) {
        ...
        if (messageList != null) {
            ...
            Collections.sort(friendData, new Comparator<FriendInfoBean>() {
            ...
            mAdapter.setNewData(friendData);
