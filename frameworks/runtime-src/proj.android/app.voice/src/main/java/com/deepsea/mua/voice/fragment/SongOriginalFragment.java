 ...
 */
public class SongOriginalFragment extends BaseFragment<FragmentSongOriginalBinding> {


    private int SongMode;

    public static SongOriginalFragment newInstance(int SongMode) {
        SongOriginalFragment instance = new SongOriginalFragment();
...
//                        ViewBindUtils.setText(mBinding.tvSongCost, String.format(getString(R.string.song_flower_cost), coin));
                    ...
                    mBinding.refreshLayout.setFocusable(false);
                    mBinding.refreshLayout.setFocusableInTouchMode(false);
//
                    break;
                case 90:
...
//                    Log.d("AG_EX_AV", "90返回" + message);
                    ...
                    if (Success == 1) {
                        ...
                        if (songerSelectForManyDialog != null) {
                            songerSelectForManyDialog.dismiss();
                        }
                    } else if (Success == 2) {
