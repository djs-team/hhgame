...
import com.deepsea.mua.im.model.EaseDefaultEmojiconDatas;
import com.deepsea.mua.im.utils.EaseSmileUtils;
import com.deepsea.mua.im.widget.EaseChatExtendMenu;
import com.deepsea.mua.im.widget.EaseChatPrimaryMenu;
import com.deepsea.mua.im.widget.EaseChatPrimaryMenuBase;
import com.deepsea.mua.im.widget.emojicon.EaseEmojiconMenu;
import com.deepsea.mua.im.widget.emojicon.EaseEmojiconMenuBase;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        rl_gift_panel = findViewById(R.id.rl_gift_panel);
    ...
    public void showGiftPannel(String toUserId, FragmentActivity activity) {
        rl_gift_panel.setVisibility(VISIBLE);
    }

    private void hideGiftPanel() {
        rl_gift_panel.setVisibility(GONE);
