...
+ (void)enterOnline {
//    [CXHTTPRequest GETWithURL:@"/index.php/Api/Member/autologin" parameters:@{@"token": [CXClientModel instance].token} callback:^(id responseObject, BOOL isCache, NSError *error) {
//        if (!error) {
