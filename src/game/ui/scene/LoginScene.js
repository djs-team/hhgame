...
load('game/ui/scene/LoginScene', function () {
    ...
    let LoginScene = BaseScene.extend({
        ...
        _userAgreeContent: [
            {
                'title': '1.重要须知',
                'content': '1.1 根据《网络游戏管理暂行规定》（文化部令第49号），文化部制定《网络游戏服务格式化协议必备条款》规定特制定本协议。本协议中甲方为《麻将情缘》，乙方为网络游戏用户。请用户仔细认真阅读、充分理解本《协议》中的各个条款。特别涉及免除或者限制《麻将情缘》责任的免责条款，对用户的权利限制的条款，法律适用、争议解决方式的条款。换行' +
                    ...
                    '1.4 本《协议》内容包括但不限于本协议以下内容，针对某些具体服务所约定的管理办法、公告、重要提示、指引、说明等均为本协议的补充内容，为本协议不可分割之组成部分，具有本协议同等法律效力，接受本协议即视为您自愿接受以上管理办法、公告、重要提示、指引、说明等并受其约束;否则请您立即停止使用《麻将情缘》提供的软件和服务。',
                'num': 4
            },
            {
                'title': '2. 特殊规定',
                'content': '2.1 未满十八周岁的未成年人应经其监护人陪同阅读本服务条款并表示同意，方可接受本服务条款。监护人应加强对未成年人的监督和保护，因其未谨慎履行监护责任而损害未成年人利益或者影响《麻将情缘》利益的，应由监护人承担责任。换行' +
                    '2.2 青少年用户应遵守全国青少年网络文明公约∶要善于网上学习，不浏览不良信息;要诚实友好交流，不侮辱欺诈他人;要增强自护意识，不随意约会网友;要维护网络安全，不破坏网络秩序;要有益身心健康，不沉溺虚拟时空。',
                'num': 3
            },
            {
                'title': '3. 权利声明',
                'content': '3.1 《麻将情缘》拥有向最终用户提供内容服务的、网址中包含hehegames.cn的互联网网站、以及《麻将情缘》网络游戏平台，《麻将情缘》手机游戏及其服务器端、最终客户端程序、文档的（包括上述内容的升级、改进版本）的所有权和一切知识产权，包括但不限于∶换行' +
                    ...
                    '3.3.6 其他严重侵犯《麻将情缘》知识产权的行为。',
                'num': 14
            },
            {
                'title': '4. 用户基本权利和责任',
                'content': '4.1用户享有由《麻将情缘》根据实际情况提供的各种服务，包括但不限于线上游戏、网上论坛、举办活动等。在某些情况下，《麻将情缘》许可用户以其账号登录或使用《麻将情缘》合作方运营的产品或服务。换行' +
                    ...
                    '4.9 用户必须严格中华人民共和国共和国境内一切法律规定，严禁利用本游戏从事包括赌博、诈骗在内的违法犯罪活动，如经发现查证属实，用户利用"《麻将情缘》从事赌博、诈骗等违法犯罪活动的，情节较轻的注销ID，禁止进入游戏，情节严重的，移送司法机关处理。玩家之间利用本游戏从事违反犯罪行为，由其自行承担法律责任，《麻将情缘》运营商无关。本游戏反对进行赌博，禁止利用游戏输赢进行线上线下的赌资结算。',
                'num': 10
            },
            {
            ...
            {
                'title': '6. 用广账号固用与保管',
                'content': '6.1《麻将情缘》有权审查用户注册所提供的身份信息是否真实、有效，并应积极地采取技术与管理等合理措施保障用户账号的安全、有效;用户有义务妥善保管其账号及密码，并根据《麻将情缘》的要求正确、安全地使用其账号及密码。因黑客行为或用户保管疏忽等非《麻将情缘》过错导致帐号、密码遭他人非法使用，《麻将情缘》不承担任何责任。换行' +
                    ...
                    '6.4 《麻将情缘》根据用户的通知采取措施暂停用户账号的登录和使用的，《麻将情缘》有权要求用户提供并核实与其注册身份信息相一致的个人有效身份信息。用户没有提供其个人有效身份证件或者用户提供的个人有效身份证件与所注册的身份信息不一致的，《麻将情缘》公司有权拒绝用户上述请求。',
                'num': 5
            },
            {
                'title': '7. 用户信息保护',
                'content': '7.1《麻将情缘》将保护用户提供的有效个人信息数据的安全。不对外向任何第三方提供、公开或共享用户注册资料中的姓名、个人有效身份证件号码、联系方式、家庭住址等个人身份信息，但下列情况除外∶换行' +
                    '7.1.1 用户或用户监护人授权披露的;换行' +
                    '7.1.2 有关法律要求披露的;换行' +
                    '7.1.3 司法机关或行政机关基于法定程序要求提供的;换行' +
                    '7.1.4 《麻将情缘》为了维护自己合法权益而披露;换行' +
                    '7.1.5 应用户监护人的合法要求而提供用户个人身份信息时。换行' +
                    '7.2 《麻将情缘》要求用户提供与其个人身份有关的信息资料时，已事先以明确而易见的方式向用户公开其隐私保护政策和个人信息利用政策，并采取必要措施保护用户的个人信息资料的安全。',
                'num': 8
            },
            {
                'title': '8. 服务的中上与终止',
                'content': '8.1 用户实施或有重大可能实施以下行为的，《麻将情缘》有权中止对其部分或全部服务，中止提供服务的方式包括但不限于暂停对该账号的登录和使用、暂时禁止使用充值服务、暂时禁止兑换相应奖品、降低或者清除账号中的积分、游戏道具等、暂时禁止使用论坛服务∶换行' +
                    ...
                    '8.3 本协议中未涉及到的禁止或限制性行为及处罚规则，由《麻将情缘》针对具体服务制定相关规定、管理办法、公告、重要提示、指引、说明等，视为本协议之补充协议，为本协议不可分割之组成部分，具有本协议同等法律效力，接受本协议即视为您自愿接受相关规定、管理办法、公告、重要提示、指引、说明等并受其约束。',
                'num': 19
            },
            {
                'title': '9. 免责条款',
                'content': '9.1 用户之间因线上游戏行为所发生或可能发生的任何心理、生理上的伤害和经济上的损失，《麻将情缘》不承担任何责任。换行' +
                    ...
                    '9.8 《麻将情缘》不保证您从第三方获得的《麻将情缘》虚拟货币、游戏道具（金币、房卡）等游戏物品能正常使用，也不保证该等物品不被索回，因私下购买虚拟货币、游戏道具（金币、房卡）等游戏物品所产生的一切损失均由用户承担，《麻将情缘》不承担任何责任。',
                'num': 9
            },
            {
                'title': '10. 法律适用和争议解',
                'content': '10.1本协议的订立、效力、解释、履行和争议的解决均适用中华人民共和国法律。因本协议所产生的以及因履行本协议而产生的任何争议，双方均应本着友好协商的原则加以解决。协商解决未果，任何一方有权向人民法院提请审理。',
                'num': 2
            },
            {
                'title': '11. 其他',
                'content': '11.1 不弃权原则。除非得到双方签字盖章的书面形式证明，否则，不得对本协议任何条款进行修改、修订或放弃。任何一方未能按照本协议规定行使权力或进行补救或延误进行，不得视为该方放弃行使该种权力，除非本协议另有明文规定。换行' +
                    '11.2 可分割性。如果本协议的任何条款违法，该条款将被修改和解释，以在法律允许的最大限度内，最好地实现原条款的目标，同时本协议的其余条款将继续保留其全部效力。',
                'num': 3
            },
        ],
