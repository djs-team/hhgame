package com.android.beauty.faceunity.utils;
...
//    }
    ...
    public static String saveDataToFile(String fileName, String fileExtName, final byte[] data) {
        ...
        final String fileFullName = Constant.filePath + fileName + "." + fileExtName;
    ...
    public static String saveBitmapToFile(final Bitmap bitmap) {
        ...
        final String fileName = Constant.filePath + getCurrentDate() +
