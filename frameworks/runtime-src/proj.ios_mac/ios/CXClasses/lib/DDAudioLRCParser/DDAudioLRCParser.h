...
@property (assign, readonly, nonatomic) NSTimeInterval startTime;
@property (assign, nonatomic) NSTimeInterval endTime;
@property (nullable, strong, nonatomic) NSString *lrc;
@property (nullable, strong, nonatomic) NSString *next_lrc;
@property (assign, nonatomic) NSInteger lrc_row;
@end
