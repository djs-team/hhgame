...
public class GalleryDialog extends BaseDialogFragment<DialogPhotoBinding> {
    ...
    public void setMinSelectdNum(int minSelectdNum) {
        this.minSelectdNum = minSelectdNum;
    }

    public void setMaxSelectdNum(int maxSelectdNum) {
        this.maxSelectdNum = maxSelectdNum;
    }

    public interface OnPhotoSelectedListener {
        void onSelected(List<LocalMedia> paths);
    }
                ...
                .subscribe(aBoolean -> {
                    if (aBoolean) {
                        PictureSelector.create(getActivity())
                                ...
                                .compress(true)// 是否压缩
                                .maxSelectNum(maxSelectdNum)
                                .minSelectNum(minSelectdNum)
                                .isGif(true)
