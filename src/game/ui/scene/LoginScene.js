...
load('game/ui/scene/LoginScene', function () {
    ...
    let LoginScene = BaseScene.extend({
        ...
        _isLookAgree: false,
        _userAgreeContent: [
            {'title':'1.重要须知','content':'1.1 根据《网络游戏管理暂行规定》（文化部令第49号），文化部制定《网络游戏服务格式化协议必备条款》规定特制定本协议。本协议中甲方为《和和福利全集》，乙方为网络游戏用户。请用户仔细认真阅读、充分理解本《协议》中的各个条款。特别涉及免除或者限制《和和福利全集》责任的免责条款，对用户的权利限制的条款，法律适用、争议解决方式的条款。换行' +
                    ...
                    '1.3 本《协议》可由《和和福利全集》随时更新，更新后的协议条款一旦公布即代替原来的协议条款，不再另行个别通知。您可重新下载安装本软件或网站查阅最新版协议条款。在《和和福利全集》修改《协议》条款后，如果您不接受修改后的条款，请立即停止使用《和和福利全集》提供的软件和服务，您继续使用《和和福利全集》提供的软件和服务将被视为已接受了修改后的协议。' +
                    '1.4 本《协议》内容包括但不限于本协议以下内容，针对某些具体服务所约定的管理办法、公告、重要提示、指引、说明等均为本协议的补充内容，为本协议不可分割之组成部分，具有本协议同等法律效力，接受本协议即视为您自愿接受以上管理办法、公告、重要提示、指引、说明等并受其约束;否则请您立即停止使用《和和福利全集》提供的软件和服务。', 'num': 4},
            {'title':'2. 特殊规定','content':'2.1 未满十八周岁的未成年人应经其监护人陪同阅读本服务条款并表示同意，方可接受本服务条款。监护人应加强对未成年人的监督和保护，因其未谨慎履行监护责任而损害未成年人利益或者影响《和和福利全集》利益的，应由监护人承担责任。换行' +
                    '2.2 青少年用户应遵守全国青少年网络文明公约∶要善于网上学习，不浏览不良信息;要诚实友好交流，不侮辱欺诈他人;要增强自护意识，不随意约会网友;要维护网络安全，不破坏网络秩序;要有益身心健康，不沉溺虚拟时空。', 'num': 3},
            {'title':'3. 权利声明','content':'3.1 《和和福利全集》拥有向最终用户提供内容服务的、网址中包含hehegames.cn的互联网网站、以及《和和福利全集》网络游戏平台，《和和福利全集》手机游戏及其服务器端、最终客户端程序、文档的（包括上述内容的升级、改进版本）的所有权和一切知识产权，包括但不限于∶换行' +
                    '3.1.1 《和和福利全集》软件及其他物品的著作权、版权、名称权、商标权以及由其派生的各项权利;换行' +
                    '3.1.2 《和和福利全集》中的电子文档、文字、数据库、图片、图标、图示、照片、程序、音乐、色彩、版面设计、界面设计等可从作品中单独使用的作品元素的著作权、版权、名称权、商标权以及由其派生的各项权利;换行' +
                    '3.1.3 《和和福利全集》向用户提供服务过程中所产生并存储于《和和福利全集》系统中的任何数据（包括但不限于账号、游戏币、游戏道具等游戏数据）的所有权。换行' +
                    '3.1.4 用户在使用《和和福利全集》游戏过程中产生的电子文档、文字、图片、照片、色彩、游戏界面等可以单独使用的游戏元素，以及由其形成的截屏、录像、录音等衍生品的各项权利。' +
                    '3.2 上述权利《和和福利全集》书面授权用户以非商业、不损害《和和福利全集》利益的目的临时的、有限的、不可转让的使用权。用户不得为商业运营目的安装、使用、运行《和和福利全集》，不可以对该软件或者该软件运行过程中释放到任何计算机终端内存中的数据及该软件运行过程中客户端与服务器端的交互数据进行复制、更改、修改、挂接运行或创作任何衍生作品，形式包括但不限于使用截屏、插件、换行' +
                    '外挂或非经授权的第三方工具/服务接入本"软件"和相关系统。换行' +
                    '3.3 未经《和和福利全集》书面同意，用户以任何营利性、非营利性或损害《和和福利全集》利益的目的实施以下几种行为的，《和和福利全集》保留追究上述未经许可行为一切法律责任的权利，给《和和福利全集》造成经济或名誉上损失的，《和和福利全集》有权根据相关法律法规另行要求赔偿，情节严重涉嫌犯罪的，《和和福利全集》将提交司法机关追究刑事责任∶换行' +
                    '3.3.1 进行编译、反编译等方式破解该软件作品的行为;换行' +
                    '3.3.2 利用技术手段破坏软件系统或者服务器的行为;换行' +
                    '3.3.3 利用游戏外挂、作弊软件、系统漏洞侵犯《和和福利全集》利益的行为;换行' +
            ...
            {'title':'4. 用户基本权利和责任','content':'4.1用户享有由《和和福利全集》根据实际情况提供的各种服务，包括但不限于线上游戏、网上论坛、举办活动等。在某些情况下，《和和福利全集》许可用户以其账号登录或使用《和和福利全集》合作方运营的产品或服务。换行' +
                    ...
                    '4.5 用户在《和和福利全集》的游戏活动应遵守中华人民共和国法律、法规，遵守《和和福利全集》的相关管理规定（包括但' +
                    '不限于管理办法、禁止性和限制性行为等），并自行承担因游戏活动直接或间接引起的一切法律责任。换行' +
                    '4.6 用户有权自主选择依照游戏设定的方式和规则进行竞赛或游戏，对其游戏活动承担相应责任和由此产生的损失，包括经济损失和精神损害。《和和福利全集》就用户的游戏的行为、活动、交易或利用《和和福利全集》进行的非法活动不承担任何责任。换行' +
                    '4.7 用户需遵守网络道德，注意网络礼仪，做到文明上网。换行' +
                    '4.8 《和和福利全集》仅提供相关的网络服务，除此之外与相关网络服务有关的上网设备（如电脑、调制解调器及其他互联网接入装置）及所需的费用（如为接入互联网而支付的电话费、上网费）均应由用户自行负责，，亦不能通过任何第三方进行兑换，游戏输赢以当局积分为准，但该积分或输赢在网络平台运营商或第三方处均不能兑换货币或实物或其他服务.换行' +
                    '4.9 用户必须严格中华人民共和国共和国境内一切法律规定，严禁利用本游戏从事包括赌博、诈骗在内的违法犯罪活动，如经发现查证属实，用户利用"《和和福利全集》从事赌博、诈骗等违法犯罪活动的，情节较轻的注销ID，禁止进入游戏，情节严重的，移送司法机关处理。玩家之间利用本游戏从事违反犯罪行为，由其自行承担法律责任，《和和福利全集》运营商无关。本游戏反对进行赌博，禁止利用游戏输赢进行线上线下的赌资结算。', 'num': 10},
            {'title':'5. 账号注册','content':'5.1 用户承诺按照《和和福利全集》的要求提供个人注册信息。换行' +
                    '社会道德风尚和信息真实性等七条底线;不得有明确或者隐含非法、骚扰性、侮辱性、恐吓性、伤害性、破坏性、挑衅性、庸俗性、淫秽色情性等内容的文字以及其他侵犯他人合法利益和人格尊严的文字或图样;不得冒用、关联机构或社会名人注册账号名称。换行' +
                    '5.2 《和和福利全集》认为必要时，有权要求用户提供国家相关机关的书面证明文件或公证机关的公证书以证明其身份证件的真实性，由此所产生之通讯费、邮寄费、交通费等一切费用均由用户自行承担。换行' +
                    '5.3 个人资料发生变更，如用户迟延更新个人注册信息导致影响《和和福利全集》对该用户提供服务，则由此产生的全部责任均由用户承担换行' +
                    ...
                    '5.6 违反第5.5条的，《和和福利全集》有权酌情采取通知限期改正、暂停使用、注销登记等措施;若情节严重的，《和和福利全集》将会向互联网信息内容主管部门报告，由此产生的全部后果均由用户承担。换行' +
                    '5.7 异常注册、异常登录（如利用非法的软件、外挂进行注册与登录）的账号会被列入《和和福利全集》黑名单中，由此产生的全部后果换行' +
                    '均由用户承担。换行' +
                    '5.8 账户所有权归属于《和和福利全集》，用户享有该账户在游戏运营期间的使用权。', 'num': 18},
            {'title':'6. 用广账号固用与保管','content':'6.1《和和福利全集》有权审查用户注册所提供的身份信息是否真实、有效，并应积极地采取技术与管理等合理措施保障用户账号的安全、有效;用户有义务妥善保管其账号及密码，并根据《和和福利全集》的要求正确、安全地使用其账号及密码。因黑客行为或用户保管疏忽等非《和和福利全集》过错导致帐号、密码遭他人非法使用，《和和福利全集》不承担任何责任。换行' +
                    '6.2 用户对登录后所持账号产生的行为依法享有权利和承担责任。换行' +
                    '6.3 用户发现其账号或密码被他人非法使用或有使用异常的情况的，应及时根据《和和福利全集》公布的账号申述规则通知《和和福利全集》，并有权通知《和和福利全集》采取措施暂停该账号的登录和使用。换行' +
            ...
            {'title':'7. 用户信息保护','content':'7.1《和和福利全集》将保护用户提供的有效个人信息数据的安全。不对外向任何第三方提供、公开或共享用户注册资料中的姓名、个人有效身份证件号码、联系方式、家庭住址等个人身份信息，但下列情况除外∶换行' +
                    '7.1.1 用户或用户监护人授权披露的;换行' +
                    '7.1.2 有关法律要求披露的;换行' +
                    '7.1.3 司法机关或行政机关基于法定程序要求提供的;换行' +
                    '7.1.4 《和和福利全集》为了维护自己合法权益而披露;换行' +
            ...
            {'title':'8. 服务的中上与终止','content':'8.1 用户实施或有重大可能实施以下行为的，《和和福利全集》有权中止对其部分或全部服务，中止提供服务的方式包括但不限于暂停对该账号的登录和使用、暂时禁止使用充值服务、暂时禁止兑换相应奖品、降低或者清除账号中的积分、游戏道具等、暂时禁止使用论坛服务∶换行' +
                    ...
                    '8.1.5 实施违反本协议和相关规定、管理办法、公告、重要提示，对《和和福利全集》和其他用户利益造成损害的其他行为。换行' +
                    '8.2 用户实施或有重大可能实施以下不正当行为的，《和和福利全集》有权终止对用户提供服务，终止提供服务的方式包括但不限于永久性的删除该账号、发表的帖子、留言、将非法所得的积分和荣誉道具清零∶换行' +
                    '8.2.1 发布违法信息、严重违背社会公德、以及其他违反法律禁止性规定的行为;换行' +
                    '8.2.2 利用《和和福利全集》进行赌博活动的行为;换行' +
                    ...
                    '8.2.7 利用游戏作弊工具或者外挂、游戏bug获取非法利益，严重侵犯《和和福利全集》利益的行为;换行' +
                    '8.2.8 发布不道德信息、广告、言论、辱骂骚扰他人，严重扰乱正常的网络秩序和游戏秩序的行为;换行' +
                    '8.2.9 实施违反本协议和相关规定、管理办法、公告、重要提示，对《和和福利全集》和其他用户利益造成严重损害的其他行为。换行' +
                    '8.3 本协议中未涉及到的禁止或限制性行为及处罚规则，由《和和福利全集》针对具体服务制定相关规定、管理办法、公告、重要提示、指引、说明等，视为本协议之补充协议，为本协议不可分割之组成部分，具有本协议同等法律效力，接受本协议即视为您自愿接受相关规定、管理办法、公告、重要提示、指引、说明等并受其约束。', 'num': 19},
            {'title':'9. 免责条款','content':'9.1 用户之间因线上游戏行为所发生或可能发生的任何心理、生理上的伤害和经济上的损失，《和和福利全集》不承担任何责任。换行' +
                    '9.2 用户因其个人原因造成账号资料保管不妥而导致个人信息数据被他人泄露或账号中虚拟财产、游戏道具被盗或损失的，《和和福利全集》不承担任何责任。换行' +
                    '9.3 用户因除了按游戏规则进行游戏的行为外的其他行为触犯了中华人民共和国法律法规的，责任自负，《和和福利全集》不承担任何责任。换行' +
                    '9.4 用户账号长期不使用的，《和和福利全集》有权进行回收，因此带来的用户个人信息数据丢失、账户内虚拟财产和游戏道具清零等一切损失由用户个人承担，《和和福利全集》不承担任何责任。换行' +
                    '9.5 用户因违反本协议8.1、8.2条款而被《和和福利全集》采取处罚措施所产生的一切损失包括但不限于虚拟货币、积分、荣誉被清零、道具失效或其他损失，均由用户个人承担，《和和福利全集》不承担任何责任。换行' +
                    '9.6 基于网络环境的复杂性，《和和福利全集》不担保服务一定能满足用户的要求，也不保证各项服务不会中断，对服务的及时性、安全性也不作担保。因网络安全、网络故障问题和其他用户的非法行为给用户造成的损失，《和和福利全集》不承担任何责任。换行' +
                    '9.7 基于网络环境的特殊性，《和和福利全集》不担保对用户限制性行为和禁止性行为的判断的准确性，用户因此产生的任何损失《和和福利全集》公司不承担任何责任，用户可按《和和福利全集》相关规定进行申诉解决。换行' +
