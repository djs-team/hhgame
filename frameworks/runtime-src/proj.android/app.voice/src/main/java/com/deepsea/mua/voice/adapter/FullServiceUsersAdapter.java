 ...
 */
public class FullServiceUsersAdapter extends BaseBindingAdapter<OnlinesBean.NearbyBean, ItemFullServiceForManyBinding> {
    ...
    public FullServiceUsersAdapter(Context context) {
        super(context);
    }

    private int canSelectMicroNum;

    public FullServiceUsersAdapter(Context context, int canSelectMicroNum) {
        super(context);
