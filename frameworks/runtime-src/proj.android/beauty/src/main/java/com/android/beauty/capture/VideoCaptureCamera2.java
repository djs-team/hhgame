...
package com.android.beauty.capture;
...
import com.android.beauty.support.IntDef;
    ...
    public boolean allocate(int width, int height, int frameRate, int facing) {
        ...
        try {
            for (String cameraId : mCameraManager.getCameraIdList()) {
                ...
                if (mFacing == Constant.CAMERA_FACING_FRONT && face == CameraMetadata.LENS_FACING_FRONT) {
                    mCamera2Id = cameraId;
                    break;
                }

                if (mFacing == Constant.CAMERA_FACING_BACK && face == CameraMetadata.LENS_FACING_BACK) {
                    mCamera2Id = cameraId;
                    break;
                }
            }
