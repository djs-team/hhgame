...
load('game/config/ResConfig', function () {
    ...
    ResConfig.Ui = {
        ...
        'MarqueeLayer': 'game/ui/layer/marquee/MarqueeLayer',
        'FirstLoginLayer':'game/ui/layer/firstlogin/FirstLoginLayer',
    ...
    ResConfig.View = {
        ...
        'FirstLoginLayer': 'res/FirstLoginLayer.json',
        'MarqueeLayer': 'res/MarqueeLayer.json',
