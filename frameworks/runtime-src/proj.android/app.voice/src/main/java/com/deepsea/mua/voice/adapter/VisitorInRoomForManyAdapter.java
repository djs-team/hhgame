 ...
 */
public class VisitorInRoomForManyAdapter extends BaseBindingAdapter<OnlineUser.UserBasis, ItemSortvisitorInroomFormanyBinding> {
    ...
    public VisitorInRoomForManyAdapter(Context context, int maxNum) {
        super(context);
        this.maxNum = maxNum;
        setUpMicroData();
    }
